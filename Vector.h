...
public:
	...
	DimInfo3(scalar_t a = 0, scalar_t b = 0, scalar_t c = 0) : x(a), y(b), z(c) {}
	DimInfo3(const DimInfo3 &dmi) : x(dmi.x), y(dmi.y), z(dmi.z) {}
};

class Point : public DimInfo3
{
public:
	Point(scalar_t a = 0, scalar_t b = 0, scalar_t c = 0) : DimInfo3(a, b, c) {}
	Point(const Point &pt) : DimInfo3(pt.x, pt.y, pt.z) {}
    //subtraction
...
class Vector : public DimInfo3
{
public:
	Vector(scalar_t a = 0, scalar_t b = 0, scalar_t c = 0) : DimInfo3(a, b, c) {}
	Vector(const Vector &vec) : DimInfo3(vec.x, vec.y, vec.z) {}
